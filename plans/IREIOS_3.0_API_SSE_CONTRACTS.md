...
Common `event_type` values (non-exhaustive): `lead.created`, `lead.scored`, `lead.assigned`, `conversation.updated`, `whatsapp.sent`, `approval.requested`, `site_visit.scheduled`.
